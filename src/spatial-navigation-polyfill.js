...
(function () {
  ...
  function initiateSpatialNavigation() {
     ...
     */
    /* Tizen-CineJoy hardening: documentElement may not exist yet when this
     * runs (e.g. document-start injection). The checks below are
     * register-if-absent; skipping them pre-parse is safe.
     */
    var __tjDocEl = null;
    try { __tjDocEl = document.documentElement; } catch (e) {}
    if (window.CSS && CSS.registerProperty && __tjDocEl) {
